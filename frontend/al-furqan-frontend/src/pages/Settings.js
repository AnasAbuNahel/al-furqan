...
const Settings = () => {
  ...
  const fetchWithAuth = (url, options = {}) => {
    ...
    const loadAdmins = () => {
    fetchWithAuth('https://al-furqan-anas-new.onrender.com/api/supervisors')
      .then(async (res) => {
  ...
  const handleAddAdmin = () => {
    ...
    fetchWithAuth('https://al-furqan-anas-new.onrender.com/api/users', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const handleRemoveAdmin = () => {
    ...
    fetchWithAuth(`https://al-furqan-anas-new.onrender.com/api/users/${id}`, {
      method: 'DELETE',
    })
      .then(async (res) => {
